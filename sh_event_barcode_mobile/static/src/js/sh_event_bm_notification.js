odoo.define('sh_event_bm_notification.NotificationService', function (require) {
'use strict';
...
var NotificationService = NotificationService.include({
	...
	notify: function (params) {
		...
		if (str_msg){
			...
			//play sound
			var src = "/sh_purchase_barcode_mobile/static/src/sounds/picked.wav";
		...
		if (str_msg){
			...
			//play sound
			var src = "/sh_purchase_barcode_mobile/static/src/sounds/error.wav";
	        $('body').append('<audio src="'+src+'" autoplay="true"></audio>');	   
		}
		//for play sound ends here	    	
